...
// Query Data hanya untuk siswa bimbingan guru yang sedang login
$sql = "SELECT s.id, u.nama, s.nis, s.kelas, j.nama as jurusan_nama,
    ...
    GROUP BY s.id ORDER BY u.nama ASC";
...
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    ...
    $filename = "Rekap_Kehadiran_Guru_" . date('Ymd_His') . ".xlsx";
...
$pageTitle = 'Rekap Laporan Siswa Bimbingan';
$showBack = true;
...
<div class="card" style="margin-bottom:20px;">
    <div style="display:flex; justify-content:flex-end; align-items:center;">
        <a href="?route=guru/rekap&export=excel" class="btn btn-primary" style="width:auto; padding:8px 15px;">
...
<div class="card" style="overflow-x: auto;">
    <table style="width: 100%; border-collapse: collapse; min-width: 800px; text-align: left;">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="8" style="padding: 20px; text-align: center; color: var(--text-muted);">Belum ada data siswa bimbingan</td>
            </tr>
            <?php else: ?>
